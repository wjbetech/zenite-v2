...
async function main() {
  ...
  for (let i = 0; i < projects.length; i++) {
    ...
    const tasks = [
      {
        ...
        // Prisma enums are validated server-side; provide string values here
        status: 'TODO',
        priority: 'HIGH',
    ...
    // createMany typing can be strict in a JS file with project TS settings.
    // Using a single-line ts-ignore keeps this simple and safe for dev-only use.
    // @ts-expect-error: relaxed typing for enum values in JS seed
