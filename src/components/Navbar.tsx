...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex w-full bg-base-200 dark:bg-base-200 backdrop-blur-sm border-b border-gray-200 dark:border-slate-700 h-[72px]">
