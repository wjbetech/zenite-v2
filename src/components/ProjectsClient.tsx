...
export default function ProjectsClient({ initialProjects }: Props) {
  ...
  return (
    <div className="flex py-2 flex-col flex-1 min-h-0 overflow-x-visible">
            ...
            {loading ? (
              ...
              <div className="col-span-full min-h-[60vh] flex items-center justify-center">
                <div className="text-center text-base-content/50">
                  <p>
                    Unable to load tasks — the database may be unavailable. Check your local DB and
                    try again, or contact the administrator (wjbetech@gmail.com)
                  </p>
                </div>
              </div>
