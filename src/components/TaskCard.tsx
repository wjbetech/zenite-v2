  ...
  return (
    <Link href={href ?? '#'} className="group block" aria-label={task.title}>
      <div className="relative">
        ...
        <div className="relative z-10 bg-white rounded-lg px-3 py-5 shadow-md transform transition-all duration-200 group-hover:-translate-y-1 group-hover:scale-[1.01] dark:bg-slate-800 dark:border dark:border-slate-700 dark:shadow-lg">
